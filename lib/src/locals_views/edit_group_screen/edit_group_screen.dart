...
class EditGroupScreen extends StatefulWidget {
  ...
  EditGroupScreen({super.key, this.eventModel});
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      setState(() {
        ...
        eventNameController.value =
            TextEditingValue(text: editGroupCubit.eventModel.title ?? '');
        groupName = editGroupCubit.eventModel.title ?? '';
        _controllerDescription.value =
            TextEditingValue(text: editGroupCubit.eventModel.description ?? '');
        // startDate = editGroupCubit.eventModel.venues?.first.startDatetime;
        ...
        //   selectedPriceValue = editGroupCubit.eventModel.pricing?.price ?? "0";
        // } else {
              ...
              children: [
                ...
                SwitchPermissionComponent(
                  ...
                  onSwitchChanged: (bool value) {
                    setState(() {
                      requireGuest = value;
                      editGroupCubit.addRequiredGuestApproval(requireGuest);
                    });
                  },
                ),
                SizedBoxConstants.sizedBoxTenH(),
                        ...
                        setState(() {
                          capacityValue =
                              _inputCapacityValuecontroller.text.isNotEmpty
                                  ...
                                  : "Unlimited";
                          editGroupCubit.addCapacity(capacityValue);
                        });
                        NavigationUtil.pop(context);
                        // _yesShareItBottomSheet();
                        // NavigationUtil.push(

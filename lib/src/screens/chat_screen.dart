...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({Key? key, this.phoneNumber}) : super(key: key);
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    String? userId = widget.phoneNumber ;
        ...
        builder: (context, snapshot) {
          ...
          final chats = snapshot.data!.map((doc) => Chat.fromMap(doc)).toList();
              return Scaffold(
                ...
                body: chats.isEmpty
                    ? Center(child: Text('No chat available'))
                    :ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ChatTileComponent(
                        ...
                        time: formatTimestamp(chat.last_message?.time ?? Timestamp.now()),
                      );
                    },

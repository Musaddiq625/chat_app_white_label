class StringConstants {
  ...
  static const String exactLocationApproval =
      "Exact location to be visible only to approved users";
  static const String requireGuestsApprovalBody =
      "Guest request to join you. Only guests you approve can see event details and chat. This cannot be changed later.";
  static const String askQuestionWhenPeopleJoin =
  ...
  static const String youWillNotBeAbleToAccessAnyMessage =
      'You will not be able to access any messages or view the group.';
  static const String yesPleaseLeave = 'Yes, please leave';

              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 14, color: ColorConstants.lightGray),
                  ),
                ],
              ),
              Spacer(),
                        ...
                        child: Column(
                          children: [
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: ColorConstants.black),
                                children: <TextSpan>[
                                  TextSpan(text: "Are you sure you want to share \n Event Fireworks night with \n "),
                                  TextSpan(
                            ...
                            Row(
                              ...
                              children: [
                                 InkWell(onTap:()=>Navigator.pop(context) ,child: Text("Go back")),

      ...
      child: ListTile(
        ...
        onTap: () {
          chat.isGroup == false
              ...
              : NavigationUtil.push(
              context, RouteConstants.groupChatRoomScreen,
              args: chat);
        },
        ...
        subtitle: Padding(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              if (FirebaseUtils.user?.id == chat.lastMessage?.fromId && chat.lastMessage?.type != MessageType.info)
              ...
              if (chat.lastMessage?.type == MessageType.image)
                ...
                if (chat.lastMessage?.type == MessageType.audio)
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(
                  ...
                  if (chat.lastMessage?.type == MessageType.video)
                    Icon(
                    ...
                    if (chat.lastMessage?.type == MessageType.document)
                      Icon(
                      ...
                      Expanded(
                          child:
                          (FirebaseUtils.user?.id == chat.lastMessage?.fromId) ?
                          Text("You ${chat.lastMessage?.msg!.split('#%#').last}" ?? '',
                            ...
                            chat.lastMessage?.msg!.replaceAll('#%#', ' ') ?? "",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            softWrap: false,
                            style: TextStyle(
